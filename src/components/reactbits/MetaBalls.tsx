// Source: https://reactbits.dev/animations/meta-balls (Tailwind + TS variant)
// Fetched via ReactBits MCP on 2026-04-23
//
// OGL-based metaballs shader — produces gooey blob fluid that merges/splits
// based on ball proximity. Good for "liquid pour", "beer foam", "wine drop"
// atmospheric effects.
